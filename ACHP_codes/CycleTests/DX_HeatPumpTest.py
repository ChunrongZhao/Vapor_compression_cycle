...
from ACHP_codes.ACHP_Tools.convert_units        import F2K
...
Cycle.CycleType                         = 'DX'                  # newly added at 07/12/2023
Cycle.Mode                              = 'HP'
Cycle.Ref                               = 'R410A'
...
params  = {
        ...
        'V_dot_ratio':                          1.0,                    # Displacement Scale factor #up- or downsize compressor
...
# -----------------------------------------------------------------------------
Cycle.Condenser.Fins.Tubes.N_Tubes_per_bank     = 32
Cycle.Condenser.Fins.Tubes.N_bank               = 3
Cycle.Condenser.Fins.Tubes.N_circuits           = 6
Cycle.Condenser.Fins.Tubes.L_tube               = 0.452
...
Cycle.Condenser.Fins.Air.V_dot_ha               = 0.5663
Cycle.Condenser.Fins.Air.T_mean                 = F2K(70)
Cycle.Condenser.Fins.Air.T_db                   = F2K(70)
...
# -----------------------------------------------------------------------------
Cycle.Evaporator.Fins.Tubes.N_Tubes_per_bank    = 41            # number of tubes per bank=row
Cycle.Evaporator.Fins.Tubes.N_bank              = 1             # number of banks/rows
Cycle.Evaporator.Fins.Tubes.N_circuits          = 5
Cycle.Evaporator.Fins.Tubes.L_tube              = 2.286
...
Cycle.Evaporator.Fins.Air.V_dot_ha              = 1.7934        # rated volumetric flowrate
Cycle.Evaporator.Fins.Air.T_mean                = F2K(40)
Cycle.Evaporator.Fins.Air.T_db                  = F2K(40)
Cycle.Evaporator.Fins.Air.p                     = 101325        # Evaporator Air pressure in Pa
Cycle.Evaporator.Fins.Air.RH                    = 0.51
Cycle.Evaporator.Fins.Air.RH_mean               = 0.51
