...
for i in range(2 * nR):
    pylab.gca().add_patch(
        FancyArrowPatch((-1, i * 0.5), (-0.5, i * 0.5), arrowstyle='-|>', fc='k', ec='k', mutation_scale=20, lw=0.8))
    pylab.gca().add_patch(
        FancyArrowPatch((nC - 0.5, i * 0.5), (nC, i * 0.5), arrowstyle='-|>', fc='k', ec='k', mutation_scale=20,
                        lw=0.8))
