...
pylab.text(5.05, -0.5, '$T_{sat,r}$', ha='left', va='center')
pylab.gca().add_patch(
    FancyArrowPatch((1, 0.5), (0.5, 0.5), arrowstyle='<|-', fc='k', ec='k', mutation_scale=20, lw=0.8))
...
pylab.gca().add_patch(
    FancyArrowPatch((4, -0.5), (4.5, -0.5), arrowstyle='<|-', fc='k', ec='k', mutation_scale=20, lw=0.8))
