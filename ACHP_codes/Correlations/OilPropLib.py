...
def Solubility_Ref_in_Liq(Ref, Liq, T, p):
    ...
    if Ref == 'R744' and Liq == 'Water':
        ...
        T_min                   = 273.15 + 40
        T_max                   = 273.15 + 100
        x_CO2                   = (8.47565584E-01 - 6.36371603E-03 * T + 1.84478093E-05 * T**2 - 2.21498670E-08 * T**3
                                   + 8.76225186E-12 * T**4 - 5.10876533E-05 * p + 3.57823191E-09 * p**2 - 1.37995983E-13 * p**3
                                   + 2.05230067E-18 * p**4 + 2.52713006E-07 * T * p - 7.95947422E-12 * T * p**2 + 8.30553293E-17 * T * p**3
                                   - 6.90483618E-10 * T**2 * p + 2.36780380E-14 * T**2 * p**2 - 2.84627591E-19 * T**2 * p**3 + 6.06021155E-13 * T**3 * p
